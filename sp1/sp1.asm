...
MAIN_MENU_ITEMS_START:
	...
	MAIN_MENU_ITEM STR_BACKUP_RAM_MGMT, manual_backup_ram_mgmt, 1
...
timer_interrupt:
	...
	ifd ROM
STR_VERSION_HEADER:		STRING "ROM DIAGNOSTICS v0.19a11 - SMKDAN/ACK"
	endif
	ifnd ROM
STR_VERSION_HEADER:		STRING "NEO DIAGNOSTICS v0.19a11 - SMKDAN/ACK"
	endif
